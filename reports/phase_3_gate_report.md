# CADi SAML Faz 3 Çıkış Kapısı Doğrulama Raporu
**Faz Adı:** Çoklu Malzeme ve Arayüz  
**Karar (Verdict):** `GATE_PASSED`  
**Sözleşme Sürümü:** `1.0.0`  
**Zaman Damgası (UTC):** `2026-09-07T16:22:11.167736+00:00`  
...
PASSED     : tests/test_heterogeneous_fea.py::test_calculix_runner_end_to_end_bimetal
PASSED     : tests/test_heterogeneous_fea.py::test_fiber_direction_rejection_not_implemented
PASSED     : tests/test_heterogeneous_fea.py::test_heterogeneous_steel_aluminum_compliance_difference
PASSED     : tests/test_heterogeneous_fea.py::test_material_region_automatic_element_mapping
